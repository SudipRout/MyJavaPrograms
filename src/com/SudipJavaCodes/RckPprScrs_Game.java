...
public class RckPprScrs_Game {
    public static void main(String[] args) {

        System.out.println("Attention please! Now we are going to play Rock, Paper and Scissor game.");
        ...
        switch (user_input) {
            ...
            default -> throw new IllegalStateException("Unexpected value: " + user_input);
        }
